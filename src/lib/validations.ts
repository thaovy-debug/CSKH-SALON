...
export const createCustomerSchema = z.object({
  ...
  purchaseContext: z.string().max(5000).optional(),
  technicalNeeds: z.string().max(3000).optional(),
  profileNotes: z.string().max(5000).optional(),
  quoteStatus: z.enum(["unknown", "yes", "no"]).optional(),
  previousAdvisor: z.string().max(300).optional(),
